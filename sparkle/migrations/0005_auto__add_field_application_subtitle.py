...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.subtitle'
        db.add_column('sparkle_application', 'subtitle', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Application.subtitle'
        db.delete_column('sparkle_application', 'subtitle')
    ...
    models = {
        'sparkle.application': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'Application Name'", 'max_length': '50'}),
            'subtitle': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        },
        ...
        'sparkle.version': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'versions'", 'to': "orm['sparkle.Application']"}),
